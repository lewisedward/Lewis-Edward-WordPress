			...
			<div class="cta-card__row">
				<div class="cta-card__heading">
					<h2 class="cta-card__title" data-reveal-clip>
						...
						<span class="cta-card__line">
							...
							<span class="cta-card__project text-primary" data-cta-project tabindex="0">
								<?php echo esc_html( $le_word ); ?>
								<?php if ( ! empty( $le_prev_ids ) ) : ?>
									<span class="cta-card__preview" data-cta-preview aria-hidden="true">
										<?php foreach ( $le_prev_ids as $idx => $att_id ) : ?>
											<img class="cta-card__preview-img<?php echo 0 === $idx ? ' is-active' : ''; ?>" src="<?php echo esc_url( wp_get_attachment_image_url( $att_id, 'le_thumb' ) ); ?>" alt="" loading="lazy" />
										<?php endforeach; ?>
									</span>
								<?php endif; ?>
							</span>
				...
				<div class="cta-card__badge-wrap">
					<a class="cta-badge" href="<?php echo esc_url( $le_cta_url ); ?>" aria-label="<?php esc_attr_e( 'Request a quote', 'lewisedward' ); ?>">
						...
						<span class="cta-badge__core" aria-hidden="true">
