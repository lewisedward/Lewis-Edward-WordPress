...
<main id="main" class="site-main site-main--archive site-main--journal">

	<header class="archive__header container">
		<?php le_breadcrumbs(); ?>
		<p class="archive__eyebrow"><?php esc_html_e( 'Notes, essays & ideas', 'lewisedward' ); ?></p>
	...
	<div class="archive__grid container">
		<?php if ( have_posts() ) : ?>
			...
			while ( have_posts() ) :
				the_post();
				get_template_part( 'template-parts/cards/card', 'journal' );
			endwhile;
			?>
		<?php else : ?>
